                            ...
                            <div className="mt-4 flex flex-col gap-2">
                                ...
                                {course.status === 'APPROVED' ? (
                                    <a
                                        ...
                                        className="flex items-center justify-center gap-2 rounded-xl border border-indigo-200 py-2.5 text-sm font-semibold text-indigo-700 hover:bg-indigo-600 hover:text-white hover:border-indigo-600 transition-all bg-indigo-50"
                                    >
                                    ...
                                    <button
                                        disabled
                                        className="flex items-center justify-center gap-1.5 rounded-xl border border-slate-200 py-2.5 text-sm font-medium text-slate-400 bg-slate-50 cursor-not-allowed"
                                    >
                                        <Clock className="h-4 w-4" />
                                        {course.status === 'REJECTED' ? "Đã bị từ chối duyệt" : "Đang chờ giảng viên duyệt"}
                                    </button>
                                )}
                            </div>
                        </motion.div>
