...
import { GET_ASSESSMENT_DETAIL, CREATE_ASSESSMENT_QUESTION, DELETE_ASSESSMENT_QUESTION, ASSESSMENT_REPORT } from "@/lib/graphql/assessment";
import { useParams, useRouter } from "next/navigation";
import { Loader2, ArrowLeft, Plus, Trash2, CheckCircle2, Copy, Users, BarChart3, ShieldAlert, Ban, XCircle } from "lucide-react";
...
export default function AssessmentEditorPage() {
    ...
    const handleCreate = async (e: any) => {
        ...
        try {
            ...
            setFormData({ prompt: "", options: ["", "", "", ""], correctAnswer: "0", explanation: "", order: formData.order + 1 });
            setShowForm(false);
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
        } catch (err: any) {
