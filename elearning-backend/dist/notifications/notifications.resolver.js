...
let NotificationsResolver = class NotificationsResolver {
    ...
    async getMyNotifications(user, take, skip) {
    ...
    async markNotificationRead(notificationId, user) {
...
__decorate([
    (0, graphql_1.Query)(() => [notification_entity_1.NotificationEntity], { name: 'myNotifications' }),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, graphql_1.Args)('take', { type: () => graphql_1.Int, defaultValue: 20, nullable: true })),
    __param(2, (0, graphql_1.Args)('skip', { type: () => graphql_1.Int, defaultValue: 0, nullable: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, Number]),
    __metadata("design:returntype", Promise)
], NotificationsResolver.prototype, "getMyNotifications", null);
__decorate([
    (0, graphql_1.Query)(() => notification_entity_1.UnreadCount, { name: 'unreadNotificationCount' }),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NotificationsResolver.prototype, "getUnreadCount", null);
__decorate([
    (0, graphql_1.Mutation)(() => Boolean),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, graphql_1.Args)('notificationId', { type: () => String })),
